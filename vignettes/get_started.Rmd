...
Use `scholid_types()` to see which identifier systems are supported by
the package.

# scholid_types()

The exact set may expand over time, but the package aims to keep a small,
stable API.
...
Classification is strict and typically expects canonical strings. A common
pattern is:
